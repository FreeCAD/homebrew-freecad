...
class Shiboken2AT51511Py310 < Formula
  ...
  def install
    ...
    ENV.append_path "CMAKE_PREFIX_PATH", formula_opt_lib("freecad/freecad/numpy@1.26.4_py310")
  ...
  post_install_steps do
    write_file "python3.10/shiboken2.pth",
               "import site; site.addsitedir('{{opt_prefix}}/lib/python3.10/site-packages/')",
