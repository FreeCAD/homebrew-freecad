...
class Coin3dAT403Py312 < Formula
  ...
  bottle do
    ...
    sha256 cellar: :any,                 arm64_sonoma: "d75dcf7cb34357e33f6a7597c17f65f304a9a0b8b8c8f8709d858eebb160dd55"
    sha256 cellar: :any_skip_relocation, x86_64_linux: "cf02c93698ce54a58aa9fcc0f8c45ce9b8bbc8113b3083b8e27d9e9d7dd4d056"
  end
  ...
  test do
    ...
    coin3d_py312_include = formula_opt_include("coin3d@4.0.3_py312")
    ...
    ENV.append_path "PYTHONPATH", formula_opt_prefix("coin3d@4.0.3_py312")/Language::Python.site_packages(python3)
    ENV.append_path "PYTHONPATH", formula_opt_prefix("pyside2@5.15.15_py312")/Language::Python.site_packages(python3)
